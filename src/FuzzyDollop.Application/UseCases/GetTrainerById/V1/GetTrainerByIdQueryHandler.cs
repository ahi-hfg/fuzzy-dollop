...
{
    public class GetTrainerByIdQueryHandler : IRequestHandler<GetTrainerByIdQuery, IAppResult>
    {
        ...
        public async Task<IAppResult> Handle(GetTrainerByIdQuery query, CancellationToken cancellationToken)
        {
